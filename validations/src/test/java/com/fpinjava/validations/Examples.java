...
import static com.fpinjava.validations.Examples.VikingValidation.EMAIL_PATTERN;
import static com.fpinjava.validations.Examples.VikingValidation.WEBSITE_URL_PATTERN;
...
public class Examples {
    ...
    public static class Viking {
        ...
        @Email public final String email;
        @javax.validation.constraints.Pattern(regexp = WEBSITE_URL_PATTERN)
        public final String website;
        @Min(0) @Max(130) public final Integer age;
